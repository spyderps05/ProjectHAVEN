# Welcome to Project H.A.V.E.N.

Your personal offline knowledge server is ready to use.

## What is H.A.V.E.N.?

**H.A.V.E.N.** stands for **Node for Offline Media, Archives, and Data**. It's your personal server for accessing knowledge, education, and AI assistance — even when you have no internet connection.
...
Run a System Benchmark to see how your hardware performs and compare your HAVEN Score with the community leaderboard.
...
**New to H.A.V.E.N.?** Use the Easy Setup wizard to configure your server and download content collections.
...
H.A.V.E.N. works best when kept up to date while you have internet access. This ensures you have the latest:
