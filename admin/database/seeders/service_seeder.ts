...
export default class ServiceSeeder extends BaseSeeder {
  ...
  private static HAVEN_STORAGE_ABS_PATH = env.get(
    'HAVEN_STORAGE_PATH',
    '/opt/project-haven/storage'
  )
  ...
  >[] = [
    {
      ...
      container_config: JSON.stringify({
        HostConfig: {
          ...
          Binds: [`${ServiceSeeder.HAVEN_STORAGE_ABS_PATH}/zim:/data`],
    ...
    },
    {
      ...
      container_config: JSON.stringify({
        HostConfig: {
          RestartPolicy: { Name: 'unless-stopped' },
          Binds: [`${ServiceSeeder.HAVEN_STORAGE_ABS_PATH}/qdrant:/qdrant/storage`],
    ...
    },
    {
      ...
      container_config: JSON.stringify({
        HostConfig: {
          RestartPolicy: { Name: 'unless-stopped' },
          Binds: [`${ServiceSeeder.HAVEN_STORAGE_ABS_PATH}/ollama:/root/.ollama`],
    ...
    },
    {
      ...
      container_config: JSON.stringify({
        HostConfig: {
          ...
          Binds: [`${ServiceSeeder.HAVEN_STORAGE_ABS_PATH}/flatnotes:/data`],
        },
        ExposedPorts: { '8080/tcp': {} },
    ...
    },
    {
      ...
      container_config: JSON.stringify({
        HostConfig: {
          ...
          Binds: [`${ServiceSeeder.HAVEN_STORAGE_ABS_PATH}/kolibri:/root/.kolibri`],
        },
        ExposedPorts: { '8080/tcp': {} },
      }),
      ui_location: '8300',
